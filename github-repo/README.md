...
[![Paper](https://img.shields.io/badge/Paper-Under%20Review-blue)](https://www.tandfonline.com/toc/oabm20/current)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Dataset](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.17582500-orange)](https://doi.org/10.5281/zenodo.17582500)
...
> *Submitted to Cogent Business & Management* (Under Review)
...
1. **Stage 1 - Weak Extraction** (`weak_extraction.yaml`): High-recall initial extraction (≤3 triples per sentence)
2. **Stage 2 - Strong Verification** (`strong_extraction.yaml`): Deduplication, confidence filtering, and entity standardization
3. **Stage 3 - RAG-Enhanced Validation** (`verification.yaml`): Context-enriched validation with three-layer RAG (local, document, graph contexts)
...
.
├── prompts/
│   ├── weak_extraction.yaml       # Stage 1: High-recall extraction
│   ├── strong_extraction.yaml     # Stage 2: Verification & deduplication
│   └── verification.yaml          # Stage 3: RAG-enhanced validation
├── schema/
...
├── docs/
│   └── extraction_protocol.md     # Detailed three-stage methodology
├── LICENSE
└── README.md
```
...
- **Zenodo Repository**: [![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.17582500-blue)](https://doi.org/10.5281/zenodo.17582500)
...
**Note**: This paper is currently under review. Citation details will be updated upon publication.
