...
Update your paper's Data Availability Statement with:
```
Corporate Sustainability Reports: All 141 reports are publicly accessible 
via Zenodo (DOI: 10.5281/zenodo.XXXXX). The dataset includes PDF files 
...
- [ ] PDFs uploaded to Zenodo (optional but recommended)
- [ ] Zenodo DOI obtained (if uploaded)
- [ ] Data Availability Statement updated in paper
- [ ] CITATION.cff updated with DOIs
