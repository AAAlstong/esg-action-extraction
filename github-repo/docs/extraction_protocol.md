...
This document provides detailed instructions for extracting structured ESG action records from corporate sustainability reports using our three-stage LLM pipeline.
...
- ✅ Semantic deduplication with hierarchical clustering
...
2. Pan et al. (2024). Unifying Large Language Models and Knowledge Graphs: A Roadmap. *IEEE TKDE*.
